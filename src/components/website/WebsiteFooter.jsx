...
const WebsiteFooter = () => {
  return (
    <div className="py-[3rem] bg-white text-black">
      <div className="wrapper flex lg:flex-row flex-col gap-7 sm:gap-14 justify-between">
        <div className="">
          ...
          <img
            ...
            alt="logo"
          />
          <p className="desc text-sm max-w-[22rem] mt-3 !text-black">
            ...
            <ul className="flex flex-col gap-3 mt-1">
              {routes.map(({ path, name }) => (
                <li key={path}>
                  <Link
                    to={path}
                    className="max-w-[22rem] flex gap-2 items-center text-black/70 hover:text-primary transition-colors duration-200"
                  >
